...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> givenRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(givenRoute.get(0)).color(GREY).width(5);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(givenRoute.get(0)).color(Color.BLACK).width(5);
        ...
        ObjectAnimator foregroundRouteAnimator = ObjectAnimator.ofObject(this,
